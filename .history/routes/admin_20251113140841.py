...
# -----------------------------
# Admin API – Users (GET = PUBLIC, others = PROTECTED)
# -----------------------------
...
# -----------------------------
# PUBLIC: GET ALL USERS – POSTMAN-READY
# -----------------------------
@admin_bp.route("/users", methods=["GET"])
def get_all_users():
    """
    Return a plain JSON list of every user in the DB.
    NO JWT, NO ADMIN CHECK, NO EXCEPTIONS.
    ...
    try:
        ...
        # If anything breaks, you’ll see the exact error
...
def get_user(user_id):
    """Return JSON for a single user (PUBLIC)."""
...
def edit_product(product_id):
    ...
    if category_id: product.category_id = int(category_id) if category_id else None
