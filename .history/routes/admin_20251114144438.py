...
def create_category():
    ...
    if image:
        ...
        path = os.path.join("static/uploads/categories", filename)
        image.save(path)
...
@admin_bp.route("/admin/api/categories/<int:category_id>", methods=["PATCH"])
@admin_bp.route("/admin/api/categories/<int:category_id>/", methods=["PATCH"])
@jwt_required()
@admin_required
...
@admin_bp.route("/admin/api/categories/<int:category_id>", methods=["DELETE"])
@admin_bp.route("/admin/api/categories/<int:category_id>/", methods=["DELETE"])
@jwt_required()
@admin_required
