...
from extensions import db, mail  # make sure you have Mail() instance in extensions
from models import User
from flask_jwt_extended import create_access_token, decode_token
from datetime import timedelta
from flask_mail import Message  # <-- THIS IS THE MISSING IMPORT


# This must come first, before any route decorators
