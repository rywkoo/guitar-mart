...
from utils.email import send_email  # your send_email function
...
def reset_password():
    ...
    reset_entry = ResetToken.query.filter_by(user_id=user.id, used=False)\
...
# --- Register routes AFTER functions are defined ---
