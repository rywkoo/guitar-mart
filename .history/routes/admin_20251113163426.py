...
def get_invoice(invoice_id):
    """
    GET /admin/api/invoices/<invoice_id>
    Returns a single invoice with full details including items.
    """
    ...
    return jsonify({
        ...
        "created_at": invoice.created_at.isoformat(),  # e.g. "2025-11-13T10:22:00"
        "items": items
    }), 200