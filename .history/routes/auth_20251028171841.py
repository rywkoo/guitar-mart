...
def register():
    ...
    new_user.set_password(password)  # assume you have a method to hash
    new_user.is_active = True        # mark active after verification
    db.session.add(new_user)
    db.session.delete(token_entry)   # delete token after successful use
    db.session.commit()
